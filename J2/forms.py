...
from .models import Intell, Addsubmission, Home
...
class IntellForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'product': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Product'), ('Commander Daily Update (CDU)', 'Commander Daily Update (CDU)'), ('Joint Collection Management Board Update (JCMB)', 'Joint COllection Mnagement Board Update (JCMB)'), (
            ...
            'rational': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Rational'), ('Force Protection', 'Force Protection'), ('SA', 'SA'), ('ISR Priorities; Collection Integration and Synchronization', 'Collection Integration and Synchronization'), ('SA Intel Ops Coordination', 'SA Intel Ops Coordination'), ('Support CAG SECDEF Report', 'Support CAG SECDEF Report'), ('Lesson Learned', 'Lesson Learned'), (
            ...
            'format': forms.Select(attrs={'class': 'form-control'}, choices=[(
            ...
            'primaryconsumer': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Primary Consumer'), ('Components & JTFs', 'Components & JTFs'), ('CDR ', 'CDR '), ('Components & JTFs, Combat Support Agencies, Other COCOMs', 'Components & JTFs, Combat Support Agencies, Other COCOMs'), ('National Agencies, Components & JTFs', 'National Agencies, Components & JTFs'), (
            ...
            'secondaryconsumer': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Secondary Consumer'), ('DoD and IC', 'DoD and IC'), ('Others, Components, JTFs & Coalition Forces', 'Others, Components, JTFs & Coalition Forces'), ('CDR, IC', 'CDR, IC'), ('IC', 'IC'), (
            ...
            'produceropr': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Producer OPR'), ('J3', 'J3'), ('J2-J, J2-X', 'J2-J, J2-X'), ('CCJ2-ISRP', 'CCJ2-ISRP'), ('J2-XH', 'J2-XH'), (
            ...
            'producerocr': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Producer OCR'), ('J2', 'J2'), ('DDI', 'DDI'), (
            ...
            'classification': forms.Select(attrs={'class': 'form-control'}, choices=[('', 'Classification'), ('S', 'S'), ('Multiple', 'Multiple'), ('SI/ TK', 'SI/ TK'), (
